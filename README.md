...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-05-08 10:23`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3eb55c3c-daad-4e60-acd5-3b6eb859bd1e.git
$ cd 3eb55c3c-daad-4e60-acd5-3b6eb859bd1e
```
